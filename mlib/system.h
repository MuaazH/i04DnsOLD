...
*/
unsigned int time_timestamp();

#ifndef SYSTEM_C_NO_NETWORK
...
/*
	...
	Call after failing to read from tcp socket to tell if the
	connection is lost, or not.

	Returns: Zero If the connection is lost
